...
我先在 `resources.md` 裡整理 IELTS 學習資源時，把 IELTS Bro 標記成「適合中文學習者參考的 Speaking question bank」來源。它的用途是幫我們知道近期口說題目有哪些，而不是拿來複製或散佈完整第三方內容。
...
```text
scripts/run_scrape_ieltsbro.ps1
```
...
```powershell
.\scripts\run_scrape_ieltsbro.ps1 --all --delay 1.5
```
